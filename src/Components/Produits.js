        ...
        <div  className="servicesbackgand">
            ...
            <div className='divproduit'>
                ...
                <div className="btn-container">
                    {/* Dynamic button generation or other content can go here */}
                </div>
                <div className="div1">
                    {listeproduits.map(produit => (
                        <div key={produit.id} className="cardproduit">
                            <img src='istockphoto-1316627014-612x612.jpg' alt="" className="cardproduit-image"/>
                            <div className="category">{produit.nom_produit}</div>
                            <div className="heading">
                                {produit.description}
                                <div className="author">{produit.author} <span className="name">{produit.authorDetail}</span></div>
                            </div>
                        </div>
                    ))}
                </div>
