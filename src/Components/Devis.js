                ...
                <form className='form'>
                        ...
                        <thead >
                            <tr className='tr-devis'>
                                <td className='td-devis'>
                                    <img src='/media/icon1.png' width='30px' /><label>Type De Service </label>
                                </td>
                                <td>
                                    <select id="typeService" name="typeService">
                                        <option value="Service">Choisir un Service </option>
                            ...
                            <tr className='tr-devis'>
                                <td className='td-devis'>
                                    <img src='/media/icon2.png' width='30px' /> <label htmlFor="typeNettoyage">Nombre d'intervention par semaine :</label>
                                </td>
                                <td>
                            ...
                            <tr className='tr-devis'>
                                <td className='td-devis'>
                                    <img src='/media/icon4.png' width='34px' /> <label htmlFor="typeNettoyage">Type de Nettoyage :</label>
                                </td>
                                <td >
                            ...
                            {showSurface && ( // Display specific areas for specific services
                                <tr className='tr-devis'>
                                    <td className='td-devis'>
                    ...
                    <div className='div1'>
                        <label className='container-checkbox'>
                            <p className='p1'>Vitre: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                        ...
                        <label className='container-checkbox'>
                            <p className='p1'>marbre: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                        <label className='container-checkbox'>
                            <p className='p1'>cristal: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                        <label className='container-checkbox'>
                            <p className='p1'>parquet: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                        <label className='container-checkbox'>
                            <p className='p1'>moquette: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                    ...
                    <div className='div1'>
                        <label className='container-checkbox'>
                            <p className='p1'>tapis: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                        <label className='container-checkbox'>
                            <p className='p1'>carrelage: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                        <label className='container-checkbox'>
                            <p className='p1'>sols en bois: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                        <label className='container-checkbox'>
                            <p className='p1'>mosaique: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
                        <label className='container-checkbox'>
                            <p className='p1'>canapés: &nbsp;&nbsp;</p><input type='checkbox' readOnly/>
                            <svg viewBox="0 0 64 64" height="30px" width="20px"className="checkbox">
                              <path d="M 0 16 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 16 L 32 48 L 64 16 V 8 A 8 8 90 0 0 56 0 H 8 A 8 8 90 0 0 0 8 V 56 A 8 8 90 0 0 8 64 H 56 A 8 8 90 0 0 64 56 V 16" pathLength="575.0541381835938" className="path"></path>
                            </svg>
                        </label>
